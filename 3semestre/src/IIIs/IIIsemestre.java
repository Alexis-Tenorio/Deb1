...
public class IIIsemestre {
	...
	if (bol==1){
		int total=(mc*50)/100;
		System.out.println("Su importe a pagar con el 50% de descuento es -->"+ total);
		
		 acum1=acum1+total;
	}
	if( bol==2){
		int total2=(mc*25)/100;
		System.out.println("Su importe a pagar con el 25% de descuento es -->"+ total2);
		System.out.println("Desea seguir ingresando  ");
		 acum2=acum2+total2;}
	if(bol==3){
		System.out.println("Su importe a pagar sin descuento es -->"+ mc);
		System.out.println("Desea seguir ingresando  ");
		 acum3=acum3+mc;
		 }
